    ...
    <main>
        ...
        <div class="container pt-5 overflow-auto">
            ...
            <form>
                ...
                <div class="form-group">
                    <label for="descricao_ctg">Preço</label>
                    <input type="text" class="form-control" id="descricao_ctg" name="preco"
                        placeholder="Ex: 750.00, 499.99">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Ativo</label>
                    <select class="form-control" id="exampleFormControlSelect1" name="ativo"
                        placeholder="Ex: 0(Não ativo), 1(Ativo)">
                        <option>0</option>
                        <option>1</option>
                    </select>
                </div>
